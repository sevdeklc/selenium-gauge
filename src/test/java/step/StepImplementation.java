...
public class StepImplementation extends BaseTest {
   ...
   @Step("<time> saniye kadar bekle")
    ...
    @Step({"Ebubekir yazdi bunu"})
    public void denemeFalan() throws InterruptedException {
       driver.get("https://www.google.com");
    }

    @Step({"Ebubekir yazdi ikinci"})
    public void denemeFalan2() throws InterruptedException {
        driver.get("https://www.google.com");
    }
